            ...
            <tr>
                <td style="padding: 0 0 30px; font-family: sans-serif; mso-height-rule: exactly; line-height: 14px; color: #000000; font-size: 14px; position: relative;" class="body_text_color body_text_size">
                    ...
                    <div style="background:#fff; border-radius: 5px; max-width: 450px; margin: 0 auto; color:#000000; line-height:1.5 !important" class="content">
                        ...
                        <p>The status of one of your job applications on <a href="{{ $data['APP_URL'] }}" target="_blank">{{ $data['APP_NAME'] }}</a> has changed.
                        </p>
                        ...
                        <p>As you know, our industry is alive and changing every moment. We encourage you
                            to keep an eye on other opportunities. You might also try exploring the <a href="{{ $data['APP_URL'] }}/mentoring-resources" target="_blank">Resources</a>
                            and <a href="{{ $data['APP_URL'] }}/publication-resources" target="_blank">Publications</a>
                            sections on our home page, or connect with other creatives in The Lounge.
                        </p>

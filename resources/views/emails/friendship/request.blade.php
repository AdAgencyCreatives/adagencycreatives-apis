                                            ...
                                            <td style="padding: 20px; font-family: sans-serif; mso-height-rule: exactly; line-height: 24px; color: #ffffff; font-size: 15px"
                                                ...
                                                <div
                                                    ...
                                                    <p><span style="color: #000000;">
                                                            {{ $data['inviter'] }} would like to become friends in The
                                                            Lounge
                                                            on { {{ env('APP_NAME') }} }.
                                                        </span>
                                                    </p>
                                                    ...
                                                    <p><span style="color: #000000;">
                                                            Click <a href="#" style="color: #3c5cc4;">my
                                                                requests</a> to
                                                            accept this invite and start a conversation, or click <a
                                                                href="#" style="color: #3c5cc4;">here</a> to view
                                                            {{ $data['inviter'] }}’s profile.
                                                        </span></p>
                                ...
                                <td style="padding: 20px; width: 100%; font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height: 19px; text-align: left; color: #ffffff; word-break: break-all;"
                                    ...
                                    <div style="text-align:center;">
                                        ...
                                        <a style="display:inline-block;width:100%;"
                                            href="mailto:info@agencycreatives.com"
                                            style="text-decoration: underline;">info@agencycreatives.com</a>
                                    </div>
                                </td>
                            </tr>
                        </table>

<p>
    Thanks,<br />
    Member Support<br />
    <img width="200" src="https://ad-agency-creatives.s3.us-east-1.amazonaws.com/agency_logo/aac-bottom-logo.png"
        alt="" />
</p>
<p style="text-align: center; margin-bottom: 0;">Gather. Inspire. Do Cool $#*t!</p>
<img class="footer-logo" style="display: block; width: 120px; position: absolute; right: 15px; bottom: 15px;"

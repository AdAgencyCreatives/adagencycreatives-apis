<div class="row">
    ...
    <div class="col-md-12 col-xl-12">
        <form id="creative-form2" action="{{ route('creative.education.update', $user->creative?->uuid) }}" method="POST">
            @csrf()
            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="college[]"
                                            placeholder="College" value="{{ $education->college }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Completed At"
                                                disabled value="{{ $education->completed_at }}">
                                        </div>
                                    </div>
                                </div>
                            </div>

            ...
            <div class="card-body">
                <form id="creative-form2" action="{{ route('creative.update', $user->creative?->uuid) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="is_vip"> VIP Candidate </label>
                                <select name="is_vip" id="is_vip"
                                    class="form-control form-select custom-select select2" data-toggle="select2">
                                    <option value="1" @if ($user->creative?->is_vip == 1) selected @endif> Yes
                                    </option>
                                    <option value="0" @if ($user->creative?->is_vip == 0) selected @endif> No
                                    </option>
                                </select>
                            </div>
                        </div>

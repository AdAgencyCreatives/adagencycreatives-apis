<div class="row d-none" id="creative-category">
    <div class="col-sm">
        <div class="form-group">
            <label class="form-label" for="category"> Category </label>
            <select name="category" id="category" class="form-control form-select custom-select select2"
                data-toggle="select2">
...
<div class="row d-none" id="creative-location">
    <div class="col-sm">
        <div class="form-group">

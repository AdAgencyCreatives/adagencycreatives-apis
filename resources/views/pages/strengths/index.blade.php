...
function fetchCategories() {
    ...
    $.ajax({
        ...
        success: function(response) {
            populateGroupFilter(response.data, '#strength');
        },
        error: function() {
            alert('Failed to fetch strengths from the API.');
        }
    });
}
...
function fetchData(page, filters = []) {
    ...
    var selectedState = $('#strength option:selected').text();

    if (selectedState != 'Select Strength') {
        filters = {
            name: selectedState
        };
    }
...
$(document).ready(function() {
    ...
    $(document).on('click', '.delete-category-btn', function() {
        ...
        deleteConfirmation(resourceId, 'strength', 'strengths', csrfToken);
    });
...
@include('pages.strengths.filters')

...
@section('title', __('Employment Type'))
    ...
    <script>
        ...
        function fetchData(page, filters = []) {
            ...
            $.ajax({
                ...
                error: function() {
                    alert('Failed to fetch employment types from the API.');
                }
            });
        }
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-category-btn', function() {
                ...
                deleteConfirmation(resourceId, 'Employment Type', 'employments', csrfToken);
            });
